  ...
  "get_react_component_tree": {
    ...
    "args": {
      "maxDepth": {
        "name": "maxDepth",
        "type": "integer",
        "description": "Maximum depth to traverse. -1 or omit for unlimited. Use a small value (e.g. 5) for large trees.",
        "required": false
      }
    }
  },
  "get_react_debug_status": {
    "description": "Check if React is detected and React debug is active on the current page.",
    "category": "Debugging",
    "args": {}
  },
  "get_react_render_events": {
  ...
  "get_render_causes": {
    ...
    "args": {
      "limit": {
        "name": "limit",
        "type": "integer",
        "description": "Maximum number of components to analyze. Default 20.",
        "required": false
      }
    }
  },
  "get_render_dependency_graph": {
    ...
    "args": {
      "limit": {
        "name": "limit",
        "type": "integer",
        "description": "Maximum depth for graph. Default 10.",
        "required": false
      }
    }
  },
